...
import { useProjectConversationLauncher } from "./useProjectConversationLauncher";
...
export function ProjectDetailPage() {
  ...
  const { launchConversation, isLaunching } = useProjectConversationLauncher(projectId);

  function handleLaunch(runPipeline: boolean) {
    void launchConversation(prompt, runPipeline)
      .then((started) => {
    ...
    >
      <section className="project-composer" aria-label="Start a chat">
        ...
        <div className="project-composer__footer">
          ...
          <button
            className="project-composer__report"
            type="button"
